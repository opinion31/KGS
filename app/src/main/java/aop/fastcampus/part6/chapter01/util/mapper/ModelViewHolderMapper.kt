...
import aop.fastcampus.part6.chapter01.widget.adapter.viewholder.friend.FriendViewHolder
    ...
    fun <M: Model> map(
        ...
        val viewHolder = when (type) {
            CellType.RESTAURANT_CELL ->
                FriendViewHolder(
                    ViewholderFriendBinding.inflate(inflater, parent, false),
                    viewModel,
                    resourcesProvider
                )
            CellType.FRIEND_CELL ->
                FriendViewHolder(
                    ViewholderFriendBinding.inflate(inflater, parent, false),
                    viewModel,
                    resourcesProvider
