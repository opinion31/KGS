...
import aop.fastcampus.part6.chapter01.data.repository.friend.DefaultFriendRepository
...
val appModule = module {
    ...
    factory { (restaurantCategory: RestaurantCategory, locationLatLngEntity: LocationLatLngEntity) ->
        RestaurantListViewModel(locationLatLngEntity, get())
    }
    ...
    single<FriendRepository> { DefaultFriendRepository(get(), get()) }
