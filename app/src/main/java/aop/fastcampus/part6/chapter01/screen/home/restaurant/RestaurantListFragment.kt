...
class RestaurantListFragment : BaseFragment<RestaurantListViewModel, FragmentListBinding>() {
    ...
    private val adapter by lazy {
        ModelRecyclerAdapter<FriendModel, RestaurantListViewModel>(listOf(), viewModel, adapterListener = object : RestaurantListListener {
            override fun onClickItem(model: FriendModel) {
//                startActivity(
